...
export const AvatarControls: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-3 relative w-full items-center">
      ...
      >
        <ToggleGroupItem
          className="data-[state=on]:bg-[#0E9E57] data-[state=on]:text-white data-[state=off]:text-black rounded-lg p-2 text-sm w-[90px] text-center"
          value="voice"
        >
          Voice Chat
        </ToggleGroupItem>
      ...
      <div className="absolute top-[-70px] right-3">
        <Button
          className="!bg-[#0E9E57] !text-white !font-light"
          onClick={interrupt}
        >
          ✋🏻 Stopp
        </Button>
